 ...
 */
const parseResumeController = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // 2. Call LLM Service
        const rawParsedData = yield (0, llm_service_1.parseResumeWithLLM)(resumeText);
        ...
        const validatedData = yield (0, validation_service_1.validateAndStandardizeResume)(rawParsedData); // <--- Added await!
