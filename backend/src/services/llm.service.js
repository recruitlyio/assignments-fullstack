...
exports.parseResumeWithLLM = void 0;
...
const model = genAI === null || genAI === void 0 ? void 0 : genAI.getGenerativeModel({ model: 'gemini-1.5-flash' }); // Or use 'gemini-pro' or other appropriate model
/**
 ...
 */
const parseResumeWithLLM = (resumeText) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    if (!model) {
    ...
    try {
        ...
        if (!candidate || candidate.finishReason !== 'STOP') {
            ...
            console.error("Gemini API Error: Response generation stopped unexpectedly.", candidate === null || candidate === void 0 ? void 0 : candidate.finishReason, candidate === null || candidate === void 0 ? void 0 : candidate.safetyRatings);
            throw new Error(`AI response generation failed or was stopped. Reason: ${candidate === null || candidate === void 0 ? void 0 : candidate.finishReason}`);
        }
