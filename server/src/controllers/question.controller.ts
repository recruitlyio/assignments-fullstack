...
import { generateNewQuestions, getAllQuestions, saveQuestionsInInterview } from "../services/question.service";
...
export const generateQuestions = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const saveInInterview = await saveQuestionsInInterview(interviewId, JSON.stringify(newQuestions));
